            ...
            <CardContent className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-1 sm:col-span-2">
                ...
                <input
                  ...
                  className="text-xs text-muted-foreground mt-1.5 file:mr-4 file:py-1.5 file:px-3 file:rounded-md file:border-0 file:text-xs file:font-semibold file:bg-secondary file:text-secondary-foreground hover:file:bg-secondary/80 cursor-pointer"
                />
              </div>
            </CardContent>
